...
template <typename TYPE>
using SafeComHolder = PreallocatedWrapper<TYPE, SafeComRelease<TYPE>>;

// Use this holder if you're already in preemptive mode for other reasons, 
// use SafeComHolder otherwise.
template <typename TYPE>
using SafeComHolderPreemp = PreallocatedWrapper<TYPE, SafeComReleasePreemp<TYPE>>;
...
template <typename TYPE>
using NewPreempHolder = PreallocatedWrapper<TYPE, DeletePreemp<TYPE>>;
